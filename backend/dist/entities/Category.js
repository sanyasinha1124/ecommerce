...
__decorate([
    (0, typeorm_1.ManyToOne)(() => ProductType_1.ProductType, type => type.categories, { onDelete: 'RESTRICT', nullable: false }),
    __metadata("design:type", ProductType_1.ProductType)
], Category.prototype, "type", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => SubCategory_1.SubCategory, sub => sub.category),
